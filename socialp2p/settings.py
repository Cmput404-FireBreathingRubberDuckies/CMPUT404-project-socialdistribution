"""
Django settings for socialp2p project.
...
SECRET_KEY = 'rgw@+##w560nkne^&ra&^+!0v9n^te#g^sstrrp&rty0cpzzbo'
...
WSGI_APPLICATION = 'socialp2p.wsgi.application'
